...
export const VIBE_CATEGORIES: Record<string, string[]> = {
  ...
  "🍳 Food & Drink": [
    ...
    "coffee", "espresso", "latte art", "tea", "matcha", "cocktails", "mixology", "wine",
  ...
  "🎉 Lifestyle": [
    ...
    "aesthetic", "memes", "tiktok", "instagram", "youtube", "podcasts", "asmr",
  ],
};

/** Flat list of all vibes */
export const ALL_VIBES: string[] = Object.values(VIBE_CATEGORIES).flat();
...
export const FEATURED_VIBES = [
  "music", "photography", "travel", "fitness", "art", "fashion",
  "coffee", "nature", "gaming", "cooking", "surfing", "meditation",
  "film", "tattoos", "tech", "yoga", "reading", "dancing",
  "anime", "sneakers", "dogs", "astrology", "skateboarding", "poetry",
];
